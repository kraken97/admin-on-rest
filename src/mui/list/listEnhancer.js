...
export const enhanceList = (Com) => {
    class List extends Component {
        ...
        render() {
            const { filters, selectProps, pagination = <DefaultPagination />, actions = <DefaultActions />, resource, hasCreate, title, data, ids, total, children, isLoading, translate } = this.props;
            ...
            return (<Com
                ...
                additionalProps={selectProps ? selectProps(this.props) : null}
                isLoading
...
export default Com => enhance(enhanceList(Com));
