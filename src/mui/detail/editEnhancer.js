...
const enhanceEdit = (Com) => {
    class Edit extends Component {
        ...
        render() {
            const { actions, children, data, hasDelete, hasShow, id, isLoading, resource, title, translate } = this.props;
            ...
            return (React.createElement(Com, {
                ...
                content: data && !isRefreshing && React.cloneElement(children, {
...
export default Com => enhance(enhanceEdit(Com));
